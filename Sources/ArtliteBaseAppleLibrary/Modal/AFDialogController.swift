...
class AFDialogController: AFBaseModalController {
    ...
    class func show(view: AFModalProtocol?, delegate: AFModalProtocolDelegate? = nil, isCancellable: Bool = true) {
        ...
        let modal = AFModalController.init(nibName: "AFDialogController", bundle: bundle)
